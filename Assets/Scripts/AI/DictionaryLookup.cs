...
private static readonly Dictionary<string, List<string>> AdjacentSpaceLookup = new Dictionary<string, List<string>>()
 {
    ...
    private static readonly Dictionary<string, HashSet<string>> WallsOfInterestLookup = new Dictionary<string, HashSet<string>>()
    {
        {"a1v", new HashSet<string>(new string[] { "b1h", "b2h", "a3v", "a2h" })},
        {"a2v", new HashSet<string>(new string[] { "b1h", "b2h", "b3h", "a4v", "a1h", "a3h" })},
        {"a3v", new HashSet<string>(new string[] { "b2h", "b3h", "b4h", "a1v",  "a5v", "a2h", "a4h" })},
        {"a4v", new HashSet<string>(new string[] { "b3h", "b4h", "b5h", "a2v",  "a6v", "a3h", "a5h" })},
        {"a5v", new HashSet<string>(new string[] { "b4h", "b5h", "b6h", "a3v",  "a7v", "a4h", "a6h" })},
        {"a6v", new HashSet<string>(new string[] { "b5h", "b6h", "b7h", "a4v",  "a8v", "a5h", "a7h" })},
        {"a7v", new HashSet<string>(new string[] { "b6h", "b7h", "b8h", "a5v", "a6h", "a8h" })},
        {"a8v", new HashSet<string>(new string[] { "b7h", "b8h", "a6v", "a7h" })},
        
        {"b1v", new HashSet<string>(new string[] { "a1h", "a2h", "c1h", "c2h", "b3v", "b2h" })},
        {"b2v", new HashSet<string>(new string[] { "a1h", "a2h", "a3h", "c1h", "c2h", "c3h", "b4v", "b1h", "b3h" })},
        {"b3v", new HashSet<string>(new string[] { "a2h", "a3h", "a4h", "c2h", "c3h", "c4h", "b1v",  "b5v", "b2h", "b4h" })},
        {"b4v", new HashSet<string>(new string[] { "a3h", "a4h", "a5h", "c3h", "c4h", "c5h", "b2v",  "b6v", "b3h", "b5h" })},
        {"b5v", new HashSet<string>(new string[] { "a4h", "a5h", "a6h", "c4h", "c5h", "c6h", "b3v",  "b7v", "b4h", "b6h" })},
        {"b6v", new HashSet<string>(new string[] { "a5h", "a6h", "a7h", "c5h", "c6h", "c7h", "b4v",  "b8v", "b5h", "b7h" })},
        {"b7v", new HashSet<string>(new string[] { "a6h", "a7h", "a8h", "c6h", "c7h", "c8h", "b5v", "b6h", "b8h" })},
        {"b8v", new HashSet<string>(new string[] { "a7h", "a8h", "c7h", "c8h", "b6v", "bh7" })},

        {"c1v", new HashSet<string>(new string[] { "b1h", "b2h", "d1h", "d2h", "c3v", "c2h"})},
        {"c2v", new HashSet<string>(new string[] { "b1h", "b2h", "b3h", "d1h", "d2h", "d3h", "c4v", "c1h", "c3h" })},
        {"c3v", new HashSet<string>(new string[] { "b2h", "b3h", "b4h", "d2h", "d3h", "d4h", "c1v",  "c5v", "c2h", "c4h" })},
        {"c4v", new HashSet<string>(new string[] { "b3h", "b4h", "b5h", "d3h", "d4h", "d5h", "c2v",  "c6v", "c3h", "c5h" })},
        {"c5v", new HashSet<string>(new string[] { "b4h", "b5h", "b6h", "d4h", "d5h", "d6h", "c3v",  "c7v", "c4h", "c6h" })},
        {"c6v", new HashSet<string>(new string[] { "b5h", "b6h", "b7h", "d5h", "d6h", "d7h", "c4v",  "c8v", "c5h", "c7h" })},
        {"c7v", new HashSet<string>(new string[] { "b6h", "b7h", "b8h", "d6h", "d7h", "d8h", "c5v", "c6h", "c8h" })},
        {"c8v", new HashSet<string>(new string[] { "b7h", "b8h", "d7h", "d8h", "c6v", "c7h" })},

        {"d1v", new HashSet<string>(new string[] { "c1h", "c2h", "e1h", "e2h", "d3v", "d2h" })},
        {"d2v", new HashSet<string>(new string[] { "c1h", "c2h", "c3h", "e1h", "e2h", "e3h", "d4v", "d1h", "d3h" })},
        {"d3v", new HashSet<string>(new string[] { "c2h", "c3h", "c4h", "e2h", "e3h", "e4h", "d1v",  "d5v", "d2h", "d4h" })},
        {"d4v", new HashSet<string>(new string[] { "c3h", "c4h", "c5h", "e3h", "e4h", "e5h", "d2v",  "d6v", "d3h", "d5h" })},
        {"d5v", new HashSet<string>(new string[] { "c4h", "c5h", "c6h", "e4h", "e5h", "e6h", "d3v",  "d7v", "d4h", "d6h" })},
        {"d6v", new HashSet<string>(new string[] { "c5h", "c6h", "c7h", "e5h", "e6h", "e7h", "d4v",  "d8v", "d5h", "d7h" })},
        {"d7v", new HashSet<string>(new string[] { "c6h", "c7h", "c8h", "e6h", "e7h", "e8h", "d5v", "d6h", "d8h" })},
        {"d8v", new HashSet<string>(new string[] { "c7h", "c8h", "e7h", "e8h", "d6v", "d7h"})},

        {"e1v", new HashSet<string>(new string[] { "d1h", "d2h", "f1h", "f2h", "e3v", "e2h" })},
        {"e2v", new HashSet<string>(new string[] { "d1h", "d2h", "d3h", "f1h", "f2h", "f3h", "e4v", "e1h", "e3h" })},
        {"e3v", new HashSet<string>(new string[] { "d2h", "d3h", "d4h", "f2h", "f3h", "f4h", "e1v",  "e5v", "e2h", "e4h" })},
        {"e4v", new HashSet<string>(new string[] { "d3h", "d4h", "d5h", "f3h", "f4h", "f5h", "e2v",  "e6v", "e3h", "e5h" })},
        {"e5v", new HashSet<string>(new string[] { "d4h", "d5h", "d6h", "f4h", "f5h", "f6h", "e3v",  "e7v", "e4h", "e6h" })},
        {"e6v", new HashSet<string>(new string[] { "d5h", "d6h", "d7h", "f5h", "f6h", "f7h", "e4v",  "e8v", "e5h", "e7h" })},
        {"e7v", new HashSet<string>(new string[] { "d6h", "d7h", "d8h", "f6h", "f7h", "f8h", "e5v", "e6h", "e8h" })},
        {"e8v", new HashSet<string>(new string[] { "d7h", "d8h", "f7h", "f8h", "e6v", "e7h" })},

        {"f1v", new HashSet<string>(new string[] { "e1h", "e2h", "g1h", "g2h", "f3v", "f2h" })},
        {"f2v", new HashSet<string>(new string[] { "e1h", "e2h", "e3h", "g1h", "g2h", "g3h", "f4v", "f1h", "f3h" })},
        {"f3v", new HashSet<string>(new string[] { "e2h", "e3h", "e4h", "g2h", "g3h", "g4h", "f1v",  "f5v", "f2h", "f4h" })},
        {"f4v", new HashSet<string>(new string[] { "e3h", "e4h", "e5h", "g3h", "g4h", "g5h", "f2v",  "f6v", "f3h", "f5h" })},
        {"f5v", new HashSet<string>(new string[] { "e4h", "e5h", "e6h", "g4h", "g5h", "g6h", "f3v",  "f7v", "f4h", "f6h" })},
        {"f6v", new HashSet<string>(new string[] { "e5h", "e6h", "e7h", "g5h", "g6h", "g7h", "f4v",  "f8v", "f5h", "f7h" })},
        {"f7v", new HashSet<string>(new string[] { "e6h", "e7h", "e8h", "g6h", "g7h", "g8h", "f5v", "f6h", "f8h" })},
        {"f8v", new HashSet<string>(new string[] { "e7h", "e8h", "g7h", "g8h", "f6v", "f7h" })},

        {"g1v", new HashSet<string>(new string[] { "f1h", "f2h", "h1h", "h2h", "g3v", "g2h", "g2h" })},
        {"g2v", new HashSet<string>(new string[] { "f1h", "f2h", "f3h", "h1h", "h2h", "h3h", "g4v", "g1h", "g3h", "g1h", "g3h" })},
        {"g3v", new HashSet<string>(new string[] { "f2h", "f3h", "f4h", "h2h", "h3h", "h4h", "g1v",  "g5v", "g2h", "g4h", "g2h", "g4h" })},
        {"g4v", new HashSet<string>(new string[] { "f3h", "f4h", "f5h", "h3h", "h4h", "h5h", "g2v",  "g6v", "g3h", "g5h", "g3h", "g5h" })},
        {"g5v", new HashSet<string>(new string[] { "f4h", "f5h", "f6h", "h4h", "h5h", "h6h", "g3v",  "g7v", "g4h", "g6h", "g4h", "g6h" })},
        {"g6v", new HashSet<string>(new string[] { "f5h", "f6h", "f7h", "h5h", "h6h", "h7h", "g4v",  "g8v", "g5h", "g7h", "g5h", "g7h" })},
        {"g7v", new HashSet<string>(new string[] { "f6h", "f7h", "f8h", "h6h", "h7h", "h8h", "g5v", "g6h", "g8h", "g6h", "g8h" })},
        {"g8v", new HashSet<string>(new string[] { "f7h", "f8h", "h7h", "h8h", "g6v", "g7h" })},

        {"h1v", new HashSet<string>(new string[] { "g1h", "g2h", "i1h", "i2h", "h3v", "h2h" })},
        {"h2v", new HashSet<string>(new string[] { "g1h", "g2h", "g3h", "i1h", "i2h", "i3h", "h4v", "h1h", "h3h" })},
        {"h3v", new HashSet<string>(new string[] { "g2h", "g3h", "g4h", "i2h", "i3h", "i4h", "h1v",  "h5v", "h2h", "h4h" })},
        {"h4v", new HashSet<string>(new string[] { "g3h", "g4h", "g5h", "i3h", "i4h", "i5h", "h2v",  "h6v", "h3h", "h5h" })},
        {"h5v", new HashSet<string>(new string[] { "g4h", "g5h", "g6h", "i4h", "i5h", "i6h", "h3v",  "h7v", "h4h", "h6h" })},
        {"h6v", new HashSet<string>(new string[] { "g5h", "g6h", "g7h", "i5h", "i6h", "i7h", "h4v",  "h8v", "h5h", "h7h" })},
        {"h7v", new HashSet<string>(new string[] { "g6h", "g7h", "g8h", "i6h", "i7h", "i8h", "h5v", "h1h", "h8h" })},
        {"h8v", new HashSet<string>(new string[] { "g7h", "g8h", "i7h", "i8h", "h6v", "h7h" })},
        
        {"a1h", new HashSet<string>(new string[] { "a2v", "b2v", "c1h", "b1v" })},
        {"a2h", new HashSet<string>(new string[] { "a1v", "a3v", "b1v", "b3v", "c2h", "b2v" })},
        {"a3h", new HashSet<string>(new string[] { "a2v", "a4v", "b2v", "b4v", "c3h", "b3v" })},
        {"a4h", new HashSet<string>(new string[] { "a3v", "a5v", "b3v", "b5v", "c4h", "b4v" })},
        {"a5h", new HashSet<string>(new string[] { "a4v", "a6v", "b4v", "b6v", "c5h", "b5v" })},
        {"a6h", new HashSet<string>(new string[] { "a5v", "a7v", "b5v", "b7v", "c6h", "b6v" })},
        {"a7h", new HashSet<string>(new string[] { "a6v", "a8v", "b6v", "b8v", "c7h", "b7v" })},
        {"a8h", new HashSet<string>(new string[] { "a7v", "b7v", "c8h", "b8v" })},

        {"b1h", new HashSet<string>(new string[] { "a2v", "b2v", "c2v", "d1h", "a1v", "c1v" })},
        {"b2h", new HashSet<string>(new string[] { "a1v", "a3v", "b1v", "b3v", "c1v", "c3v", "d2h", "a2v", "c2v" })},
        {"b3h", new HashSet<string>(new string[] { "a2v", "a4v", "b2v", "b4v", "c2v", "c4v", "d3h", "a3v", "c3v" })},
        {"b4h", new HashSet<string>(new string[] { "a3v", "a5v", "b3v", "b5v", "c3v", "c5v", "d4h", "a4v", "c4v" })},
        {"b5h", new HashSet<string>(new string[] { "a4v", "a6v", "b4v", "b6v", "c4v", "c6v", "d5h", "a5v", "c5v" })},
        {"b6h", new HashSet<string>(new string[] { "a5v", "a7v", "b5v", "b7v", "c5v", "c7v", "d6h", "a6v", "c6v" })},
        {"b7h", new HashSet<string>(new string[] { "a6v", "a8v", "b6v", "b8v", "c6v", "c8v", "d7h", "a7v", "c7v" })},
        {"b8h", new HashSet<string>(new string[] { "a7v", "b7v", "c7v", "d8h", "a8v", "c8v" })},

        {"c1h", new HashSet<string>(new string[] { "b2v", "c2v", "d2v", "a1h", "e1h", "b1v", "c1v" })},
        {"c2h", new HashSet<string>(new string[] { "b1v", "b3v", "c1v", "c3v", "d1v", "d3v", "a2h", "e2h", "b2v", "d2v" })},
        {"c3h", new HashSet<string>(new string[] { "b2v", "b4v", "c2v", "c4v", "d2v", "d4v", "a3h", "e3h", "b3v", "d3v" })},
        {"c4h", new HashSet<string>(new string[] { "b3v", "b5v", "c3v", "c5v", "d3v", "d5v", "a4h", "e4h", "b4v", "d4v" })},
        {"c5h", new HashSet<string>(new string[] { "b4v", "b6v", "c4v", "c6v", "d4v", "d6v", "a5h", "e5h", "b5v", "d5v" })},
        {"c6h", new HashSet<string>(new string[] { "b5v", "b7v", "c5v", "c7v", "d5v", "d7v", "a6h", "e6h", "b6v", "d6v" })},
        {"c7h", new HashSet<string>(new string[] { "b6v", "b8v", "c6v", "c8v", "d6v", "d8v", "a7h", "e7h", "b7v", "d7v" })},
        {"c8h", new HashSet<string>(new string[] { "b7v", "c7v", "d7v", "a8h", "e8h", "b8v", "d8v" })},

        {"d1h", new HashSet<string>(new string[] { "c2v", "d2v", "e2v", "b1h", "f1h", "c1v", "e1v" })},
        {"d2h", new HashSet<string>(new string[] { "c1v", "c3v", "d1v", "d3v", "e1v", "e3v", "b2h", "f2h", "c2v", "e2v" })},
        {"d3h", new HashSet<string>(new string[] { "c2v", "c4v", "d2v", "d4v", "e2v", "e4v", "b3h", "f3h", "c3v", "e3v" })},
        {"d4h", new HashSet<string>(new string[] { "c3v", "c5v", "d3v", "d5v", "e3v", "e5v", "b4h", "f4h", "c4v", "e4v" })},
        {"d5h", new HashSet<string>(new string[] { "c4v", "c6v", "d4v", "d6v", "e4v", "e6v", "b5h", "f5h", "c5v", "e5v" })},
        {"d6h", new HashSet<string>(new string[] { "c5v", "c7v", "d5v", "d7v", "e5v", "e7v", "b6h", "f6h", "c6v", "e6v" })},
        {"d7h", new HashSet<string>(new string[] { "c6v", "c8v", "d6v", "d8v", "e6v", "e8v", "b7h", "f7h", "c7v", "e7v" })},
        {"d8h", new HashSet<string>(new string[] { "c7v", "d7v", "e7v", "b8h", "f8h", "c8v", "e8v" })},

        {"e1h", new HashSet<string>(new string[] { "d2v", "e2v", "f2v", "c1h", "g1h", "d1v", "f1v" })},
        {"e2h", new HashSet<string>(new string[] { "d1v", "d3v", "e1v", "e3v", "f1v", "f3v", "c2h", "g2h", "d2v", "f2v" })},
        {"e3h", new HashSet<string>(new string[] { "d2v", "d4v", "e2v", "e4v", "f2v", "f4v", "c3h", "g3h", "d3v", "f3v" })},
        {"e4h", new HashSet<string>(new string[] { "d3v", "d5v", "e3v", "e5v", "f3v", "f5v", "c4h", "g4h", "d4v", "f4v" })},
        {"e5h", new HashSet<string>(new string[] { "d4v", "d6v", "e4v", "e6v", "f4v", "f6v", "c5h", "g5h", "d5v", "f5v" })},
        {"e6h", new HashSet<string>(new string[] { "d5v", "d7v", "e5v", "e7v", "f5v", "f7v", "c6h", "g6h", "d6v", "f6v" })},
        {"e7h", new HashSet<string>(new string[] { "d6v", "d8v", "e6v", "e8v", "f6v", "f8v", "c7h", "g7h", "d7v", "f7v" })},
        {"e8h", new HashSet<string>(new string[] { "d7v", "e7v", "f7v", "c8h", "g8h", "d8v", "f8v" })},

        {"f1h", new HashSet<string>(new string[] { "e2v", "f2v", "g2v", "d1h", "h1h", "e1v", "g1v" })},
        {"f2h", new HashSet<string>(new string[] { "e1v", "e3v", "f1v", "f3v", "g1v", "g3v", "d2h", "h2h", "e2v", "g2v" })},
        {"f3h", new HashSet<string>(new string[] { "e2v", "e4v", "f2v", "f4v", "g2v", "g4v", "d3h", "h3h", "e3v", "g3v" })},
        {"f4h", new HashSet<string>(new string[] { "e3v", "e5v", "f3v", "f5v", "g3v", "g5v", "d4h", "h4h", "e4v", "g4v" })},
        {"f5h", new HashSet<string>(new string[] { "e4v", "e6v", "f4v", "f6v", "g4v", "g6v", "d5h", "h5h", "e5v", "g5v" })},
        {"f6h", new HashSet<string>(new string[] { "e5v", "e7v", "f5v", "f7v", "g5v", "g7v", "d6h", "h6h", "e6v", "g6v" })},
        {"f7h", new HashSet<string>(new string[] { "e6v", "e8v", "f6v", "f8v", "g6v", "g8v", "d7h", "h7h", "e7v", "g7v" })},
        {"f8h", new HashSet<string>(new string[] { "e7v", "f7v", "g7v", "d8h", "h8h", "e8v", "g8v" })},

        {"g1h", new HashSet<string>(new string[] { "f2v", "g2v", "h2v", "e1h", "i1h", "f1v", "h1v" })},
        {"g2h", new HashSet<string>(new string[] { "f1v", "f3v", "g1v", "g3v", "h1v", "h3v", "e2h", "i2h", "f2v", "h2v" })},
        {"g3h", new HashSet<string>(new string[] { "f2v", "f4v", "g2v", "g4v", "h2v", "h4v", "e3h", "i3h", "f3v", "h3v" })},
        {"g4h", new HashSet<string>(new string[] { "f3v", "f5v", "g3v", "g5v", "h3v", "h5v", "e4h", "i4h", "f4v", "h4v" })},
        {"g5h", new HashSet<string>(new string[] { "f4v", "f6v", "g4v", "g6v", "h4v", "h6v", "e5h", "i5h", "f5v", "h5v" })},
        {"g6h", new HashSet<string>(new string[] { "f5v", "f7v", "g5v", "g7v", "h5v", "h7v", "e6h", "i6h", "f6v", "h6v" })},
        {"g7h", new HashSet<string>(new string[] { "f6v", "f8v", "g6v", "g8v", "h6v", "h8v", "e7h", "i7h", "f7v", "h7v" })},
        {"g8h", new HashSet<string>(new string[] { "f7v", "g7v", "h7v", "e8h", "i8h", "f8v", "h8v" })},

        {"h1h", new HashSet<string>(new string[] { "g2v", "h2v", "i2v", "f1h", "g1v" })},
        {"h2h", new HashSet<string>(new string[] { "g1v", "g3v", "h1v", "h3v", "i1v", "i3v", "f2h", "g2v" })},
        {"h3h", new HashSet<string>(new string[] { "g2v", "g4v", "h2v", "h4v", "i2v", "i4v", "f3h", "g3v" })},
        {"h4h", new HashSet<string>(new string[] { "g3v", "g5v", "h3v", "h5v", "i3v", "i5v", "f4h", "g4v" })},
        {"h5h", new HashSet<string>(new string[] { "g4v", "g6v", "h4v", "h6v", "i4v", "i6v", "f5h", "g5v" })},
        {"h6h", new HashSet<string>(new string[] { "g5v", "g7v", "h5v", "h7v", "i5v", "i7v", "f6h", "g6v" })},
        {"h7h", new HashSet<string>(new string[] { "g6v", "g8v", "h6v", "h8v", "i6v", "i8v", "f7h", "g7v" })},
        {"h8h", new HashSet<string>(new string[] { "g7v", "h7v", "i7v", "f8h", "g8v" })},
};

    public static HashSet<string> PerformWallsOfInterestLookup(string wall)
    {

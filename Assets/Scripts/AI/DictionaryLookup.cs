...
private static readonly Dictionary<string, List<string>> AdjacentSpaceLookup = new Dictionary<string, List<string>>()
 {
    ...
    {
        {"a1v", new List<string>(new string[] { "b1h", "b2h", "a3v" })},
        {"a2v", new List<string>(new string[] { "b1h", "b2h", "b3h", "a4v" })},
        {"a3v", new List<string>(new string[] { "b2h", "b3h", "b4h", "a1v",  "a5v" })},
        {"a4v", new List<string>(new string[] { "b3h", "b4h", "b5h", "a2v",  "a6v" })},
        {"a5v", new List<string>(new string[] { "b4h", "b5h", "b6h", "a3v",  "a7v" })},
        {"a6v", new List<string>(new string[] { "b5h", "b6h", "b7h", "a4v",  "a8v" })},
        {"a7v", new List<string>(new string[] { "b6h", "b7h", "b8h", "a5v" })},
        {"a8v", new List<string>(new string[] { "b7h", "b8h", "a6v" })},

        {"b1v", new List<string>(new string[] { "a1h", "a2h", "c1h", "c2h", "b3v" })},
        {"b2v", new List<string>(new string[] { "a1h", "a2h", "a3h", "c1h", "c2h", "c3h", "b4v" })},
        {"b3v", new List<string>(new string[] { "a2h", "a3h", "a4h", "c2h", "c3h", "c4h", "b1v",  "b5v" })},
        {"b4v", new List<string>(new string[] { "a3h", "a4h", "a5h", "c3h", "c4h", "c5h", "b2v",  "b6v" })},
        {"b5v", new List<string>(new string[] { "a4h", "a5h", "a6h", "c4h", "c5h", "c6h", "b3v",  "b7v" })},
        {"b6v", new List<string>(new string[] { "a5h", "a6h", "a7h", "c5h", "c6h", "c7h", "b4v",  "b8v" })},
        {"b7v", new List<string>(new string[] { "a6h", "a7h", "a8h", "c6h", "c7h", "c8h", "b5v" })},
        {"b8v", new List<string>(new string[] { "a7h", "a8h", "c7h", "c8h", "b6v" })},

        {"c1v", new List<string>(new string[] { "b1h", "b2h", "d1h", "d2h", "c3v" })},
        {"c2v", new List<string>(new string[] { "b1h", "b2h", "b3h", "d1h", "d2h", "d3h", "c4v" })},
        {"c3v", new List<string>(new string[] { "b2h", "b3h", "b4h", "d2h", "d3h", "d4h", "c1v",  "c5v" })},
        {"c4v", new List<string>(new string[] { "b3h", "b4h", "b5h", "d3h", "d4h", "d5h", "c2v",  "c6v" })},
        {"c5v", new List<string>(new string[] { "b4h", "b5h", "b6h", "d4h", "d5h", "d6h", "c3v",  "c7v" })},
        {"c6v", new List<string>(new string[] { "b5h", "b6h", "b7h", "d5h", "d6h", "d7h", "c4v",  "c8v" })},
        {"c7v", new List<string>(new string[] { "b6h", "b7h", "b8h", "d6h", "d7h", "d8h", "c5v" })},
        {"c8v", new List<string>(new string[] { "b7h", "b8h", "d7h", "d8h", "c6v" })},

        {"d1v", new List<string>(new string[] { "c1h", "c2h", "e1h", "e2h", "d3v" })},
        {"d2v", new List<string>(new string[] { "c1h", "c2h", "c3h", "e1h", "e2h", "e3h", "d4v" })},
        {"d3v", new List<string>(new string[] { "c2h", "c3h", "c4h", "e2h", "e3h", "e4h", "d1v",  "d5v" })},
        {"d4v", new List<string>(new string[] { "c3h", "c4h", "c5h", "e3h", "e4h", "e5h", "d2v",  "d6v" })},
        {"d5v", new List<string>(new string[] { "c4h", "c5h", "c6h", "e4h", "e5h", "e6h", "d3v",  "d7v" })},
        {"d6v", new List<string>(new string[] { "c5h", "c6h", "c7h", "e5h", "e6h", "e7h", "d4v",  "d8v" })},
        {"d7v", new List<string>(new string[] { "c6h", "c7h", "c8h", "e6h", "e7h", "e8h", "d5v" })},
        {"d8v", new List<string>(new string[] { "c7h", "c8h", "e7h", "e8h", "d6v" })},

        {"e1v", new List<string>(new string[] { "d1h", "d2h", "f1h", "f2h", "e3v" })},
        {"e2v", new List<string>(new string[] { "d1h", "d2h", "d3h", "f1h", "f2h", "f3h", "e4v" })},
        {"e3v", new List<string>(new string[] { "d2h", "d3h", "d4h", "f2h", "f3h", "f4h", "e1v",  "e5v" })},
        {"e4v", new List<string>(new string[] { "d3h", "d4h", "d5h", "f3h", "f4h", "f5h", "e2v",  "e6v" })},
        {"e5v", new List<string>(new string[] { "d4h", "d5h", "d6h", "f4h", "f5h", "f6h", "e3v",  "e7v" })},
        {"e6v", new List<string>(new string[] { "d5h", "d6h", "d7h", "f5h", "f6h", "f7h", "e4v",  "e8v" })},
        {"e7v", new List<string>(new string[] { "d6h", "d7h", "d8h", "f6h", "f7h", "f8h", "e5v" })},
        {"e8v", new List<string>(new string[] { "d7h", "d8h", "f7h", "f8h", "e6v" })},

        {"f1v", new List<string>(new string[] { "e1h", "e2h", "g1h", "g2h", "f3v" })},
        {"f2v", new List<string>(new string[] { "e1h", "e2h", "e3h", "g1h", "g2h", "g3h", "f4v" })},
        {"f3v", new List<string>(new string[] { "e2h", "e3h", "e4h", "g2h", "g3h", "g4h", "f1v",  "f5v" })},
        {"f4v", new List<string>(new string[] { "e3h", "e4h", "e5h", "g3h", "g4h", "g5h", "f2v",  "f6v" })},
        {"f5v", new List<string>(new string[] { "e4h", "e5h", "e6h", "g4h", "g5h", "g6h", "f3v",  "f7v" })},
        {"f6v", new List<string>(new string[] { "e5h", "e6h", "e7h", "g5h", "g6h", "g7h", "f4v",  "f8v" })},
        {"f7v", new List<string>(new string[] { "e6h", "e7h", "e8h", "g6h", "g7h", "g8h", "f5v" })},
        {"f8v", new List<string>(new string[] { "e7h", "e8h", "g7h", "g8h", "f6v" })},

        {"g1v", new List<string>(new string[] { "f1h", "f2h", "h1h", "h2h", "g3v" })},
        {"g2v", new List<string>(new string[] { "f1h", "f2h", "f3h", "h1h", "h2h", "h3h", "g4v" })},
        {"g3v", new List<string>(new string[] { "f2h", "f3h", "f4h", "h2h", "h3h", "h4h", "g1v",  "g5v" })},
        {"g4v", new List<string>(new string[] { "f3h", "f4h", "f5h", "h3h", "h4h", "h5h", "g2v",  "g6v" })},
        {"g5v", new List<string>(new string[] { "f4h", "f5h", "f6h", "h4h", "h5h", "h6h", "g3v",  "g7v" })},
        {"g6v", new List<string>(new string[] { "f5h", "f6h", "f7h", "h5h", "h6h", "h7h", "g4v",  "g8v" })},
        {"g7v", new List<string>(new string[] { "f6h", "f7h", "f8h", "h6h", "h7h", "h8h", "g5v" })},
        {"g8v", new List<string>(new string[] { "f7h", "f8h", "h7h", "h8h", "g6v" })},

        {"h1v", new List<string>(new string[] { "g1h", "g2h", "i1h", "i2h", "h3v" })},
        {"h2v", new List<string>(new string[] { "g1h", "g2h", "g3h", "i1h", "i2h", "i3h", "h4v" })},
        {"h3v", new List<string>(new string[] { "g2h", "g3h", "g4h", "i2h", "i3h", "i4h", "h1v",  "h5v" })},
        {"h4v", new List<string>(new string[] { "g3h", "g4h", "g5h", "i3h", "i4h", "i5h", "h2v",  "h6v" })},
        {"h5v", new List<string>(new string[] { "g4h", "g5h", "g6h", "i4h", "i5h", "i6h", "h3v",  "h7v" })},
        {"h6v", new List<string>(new string[] { "g5h", "g6h", "g7h", "i5h", "i6h", "i7h", "h4v",  "h8v" })},
        {"h7v", new List<string>(new string[] { "g6h", "g7h", "g8h", "i6h", "i7h", "i8h", "h5v" })},
        {"h8v", new List<string>(new string[] { "g7h", "g8h", "i7h", "i8h", "h6v" })},
        
        {"a1h", new List<string>(new string[] { "a2v", "b2v", "c1h" })},
        {"a2h", new List<string>(new string[] { "a1v", "a3v", "b1v", "b3v", "c2h" })},
        {"a3h", new List<string>(new string[] { "a2v", "a4v", "b2v", "b4v", "c3h" })},
        {"a4h", new List<string>(new string[] { "a3v", "a5v", "b3v", "b5v", "c4h" })},
        {"a5h", new List<string>(new string[] { "a4v", "a6v", "b4v", "b6v", "c5h" })},
        {"a6h", new List<string>(new string[] { "a5v", "a7v", "b5v", "b7v", "c6h" })},
        {"a7h", new List<string>(new string[] { "a6v", "a8v", "b6v", "b8v", "c7h" })},
        {"a8h", new List<string>(new string[] { "a7v", "b7v", "c8h" })},

        {"b1h", new List<string>(new string[] { "a2v", "b2v", "c2v", "d1h" })},
        {"b2h", new List<string>(new string[] { "a1v", "a3v", "b1v", "b3v", "c1v", "c3v", "d2h" })},
        {"b3h", new List<string>(new string[] { "a2v", "a4v", "b2v", "b4v", "c2v", "c4v", "d3h" })},
        {"b4h", new List<string>(new string[] { "a3v", "a5v", "b3v", "b5v", "c3v", "c5v", "d4h" })},
        {"b5h", new List<string>(new string[] { "a4v", "a6v", "b4v", "b6v", "c4v", "c6v", "d5h" })},
        {"b6h", new List<string>(new string[] { "a5v", "a7v", "b5v", "b7v", "c5v", "c7v", "d6h" })},
        {"b7h", new List<string>(new string[] { "a6v", "a8v", "b6v", "b8v", "c6v", "c8v", "d7h" })},
        {"b8h", new List<string>(new string[] { "a7v", "b7v", "c7v", "d8h" })},

        {"c1h", new List<string>(new string[] { "b2v", "c2v", "d2v", "a1h", "e1h" })},
        {"c2h", new List<string>(new string[] { "b1v", "b3v", "c1v", "c3v", "d1v", "d3v", "a2h", "e2h" })},
        {"c3h", new List<string>(new string[] { "b2v", "b4v", "c2v", "c4v", "d2v", "d4v", "a3h", "e3h" })},
        {"c4h", new List<string>(new string[] { "b3v", "b5v", "c3v", "c5v", "d3v", "d5v", "a4h", "e4h" })},
        {"c5h", new List<string>(new string[] { "b4v", "b6v", "c4v", "c6v", "d4v", "d6v", "a5h", "e5h" })},
        {"c6h", new List<string>(new string[] { "b5v", "b7v", "c5v", "c7v", "d5v", "d7v", "a6h", "e6h" })},
        {"c7h", new List<string>(new string[] { "b6v", "b8v", "c6v", "c8v", "d6v", "d8v", "a7h", "e7h" })},
        {"c8h", new List<string>(new string[] { "b7v", "c7v", "d7v", "a8h", "e8h" })},

        {"d1h", new List<string>(new string[] { "c2v", "d2v", "e2v", "b1h", "f1h" })},
        {"d2h", new List<string>(new string[] { "c1v", "c3v", "d1v", "d3v", "e1v", "e3v", "b2h", "f2h" })},
        {"d3h", new List<string>(new string[] { "c2v", "c4v", "d2v", "d4v", "e2v", "e4v", "b3h", "f3h" })},
        {"d4h", new List<string>(new string[] { "c3v", "c5v", "d3v", "d5v", "e3v", "e5v", "b4h", "f4h" })},
        {"d5h", new List<string>(new string[] { "c4v", "c6v", "d4v", "d6v", "e4v", "e6v", "b5h", "f5h" })},
        {"d6h", new List<string>(new string[] { "c5v", "c7v", "d5v", "d7v", "e5v", "e7v", "b6h", "f6h" })},
        {"d7h", new List<string>(new string[] { "c6v", "c8v", "d6v", "d8v", "e6v", "e8v", "b7h", "f7h" })},
        {"d8h", new List<string>(new string[] { "c7v", "d7v", "e7v", "b8h", "f8h" })},

        {"e1h", new List<string>(new string[] { "d2v", "e2v", "f2v", "c1h", "g1h" })},
        {"e2h", new List<string>(new string[] { "d1v", "d3v", "e1v", "e3v", "f1v", "f3v", "c2h", "g2h" })},
        {"e3h", new List<string>(new string[] { "d2v", "d4v", "e2v", "e4v", "f2v", "f4v", "c3h", "g3h" })},
        {"e4h", new List<string>(new string[] { "d3v", "d5v", "e3v", "e5v", "f3v", "f5v", "c4h", "g4h" })},
        {"e5h", new List<string>(new string[] { "d4v", "d6v", "e4v", "e6v", "f4v", "f6v", "c5h", "g5h" })},
        {"e6h", new List<string>(new string[] { "d5v", "d7v", "e5v", "e7v", "f5v", "f7v", "c6h", "g6h" })},
        {"e7h", new List<string>(new string[] { "d6v", "d8v", "e6v", "e8v", "f6v", "f8v", "c7h", "g7h" })},
        {"e8h", new List<string>(new string[] { "d7v", "e7v", "f7v", "c8h", "g8h" })},

        {"f1h", new List<string>(new string[] { "e2v", "f2v", "g2v", "d1h", "h1h" })},
        {"f2h", new List<string>(new string[] { "e1v", "e3v", "f1v", "f3v", "g1v", "g3v", "d2h", "h2h" })},
        {"f3h", new List<string>(new string[] { "e2v", "e4v", "f2v", "f4v", "g2v", "g4v", "d3h", "h3h" })},
        {"f4h", new List<string>(new string[] { "e3v", "e5v", "f3v", "f5v", "g3v", "g5v", "d4h", "h4h" })},
        {"f5h", new List<string>(new string[] { "e4v", "e6v", "f4v", "f6v", "g4v", "g6v", "d5h", "h5h" })},
        {"f6h", new List<string>(new string[] { "e5v", "e7v", "f5v", "f7v", "g5v", "g7v", "d6h", "h6h" })},
        {"f7h", new List<string>(new string[] { "e6v", "e8v", "f6v", "f8v", "g6v", "g8v", "d7h", "h7h" })},
        {"f8h", new List<string>(new string[] { "e7v", "f7v", "g7v", "d8h", "h8h" })},

        {"g1h", new List<string>(new string[] { "f2v", "g2v", "h2v", "e1h", "i1h" })},
        {"g2h", new List<string>(new string[] { "f1v", "f3v", "g1v", "g3v", "h1v", "h3v", "e2h", "i2h" })},
        {"g3h", new List<string>(new string[] { "f2v", "f4v", "g2v", "g4v", "h2v", "h4v", "e3h", "i3h" })},
        {"g4h", new List<string>(new string[] { "f3v", "f5v", "g3v", "g5v", "h3v", "h5v", "e4h", "i4h" })},
        {"g5h", new List<string>(new string[] { "f4v", "f6v", "g4v", "g6v", "h4v", "h6v", "e5h", "i5h" })},
        {"g6h", new List<string>(new string[] { "f5v", "f7v", "g5v", "g7v", "h5v", "h7v", "e6h", "i6h" })},
        {"g7h", new List<string>(new string[] { "f6v", "f8v", "g6v", "g8v", "h6v", "h8v", "e7h", "i7h" })},
        {"g8h", new List<string>(new string[] { "f7v", "g7v", "h7v", "e8h", "i8h" })},

        {"h1h", new List<string>(new string[] { "g2v", "h2v", "i2v", "f1h" })},
        {"h2h", new List<string>(new string[] { "g1v", "g3v", "h1v", "h3v", "i1v", "i3v", "f2h" })},
        {"h3h", new List<string>(new string[] { "g2v", "g4v", "h2v", "h4v", "i2v", "i4v", "f3h" })},
        {"h4h", new List<string>(new string[] { "g3v", "g5v", "h3v", "h5v", "i3v", "i5v", "f4h" })},
        {"h5h", new List<string>(new string[] { "g4v", "g6v", "h4v", "h6v", "i4v", "i6v", "f5h" })},
        {"h6h", new List<string>(new string[] { "g5v", "g7v", "h5v", "h7v", "i5v", "i7v", "f6h" })},
        {"h7h", new List<string>(new string[] { "g6v", "g8v", "h6v", "h8v", "i6v", "i8v", "f7h" })},
        {"h8h", new List<string>(new string[] { "g7v", "h7v", "i7v", "f8h" })},
};
